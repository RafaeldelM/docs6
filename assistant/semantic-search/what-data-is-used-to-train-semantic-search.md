# What data is used to train Semantic Search

{% hint style="success" %}
**Important note:** No data leaves your computer. All processing runs locally. 100% privacy.
{% endhint %}

Below is the information extracted from the files to train the AI for Semantic Search.
