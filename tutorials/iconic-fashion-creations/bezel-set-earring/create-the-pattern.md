---
description: 'Objective: Arrange the circles into a pattern that fits the earring design.'
---
...
Adjust the curves where necessary to ensure that every intersection meets the **1.5 mm** minimum distance requirement for stability.

**Video Lesson**

{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/Lesson-3-E.mp4" %}

**Next Step**: Create gemstones from the circles and apply the bezel set.
