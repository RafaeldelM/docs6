---
description: 'Objective: Build the ring shank using the advanced command.'
---
...
Set the opening parameters.

* Opening size: 13 millimeters.
* Opening mode: Round.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/L4.mp4" %}

**Next Step:** Adjust the shank profiles to complete the design.
