---
description: 'Objective: Set up the initial shank size for your fashion ring.'
---

# Reference Curve

### **Steps 1: Download Resources**

**Download** the provided 3dm file that contains the necessary curves.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/01-Curve-Ref.mp4" %}

**Next Step:** Use the Gem Studio command to create and position a 1.50-carat oval stone on the shank curve.
