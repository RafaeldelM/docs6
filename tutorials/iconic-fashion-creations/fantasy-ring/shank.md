---
description: 'Objective: Create and adjust the custom cathedral shank.'
---

# Shank

### **Step1: Cathedral Shank**
...
![](<../../../.gitbook/assets/01 Cathedral Shank.png>)
...
* Top width: 2.70 millimeters.
* Top height: 2 millimeters.
* Bottom width: 2.5 millimeters.
* Bottom height: 1.6 millimeters.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/Fantasy_L5.mp4" %}

**Next Step:** Adjust the shank bridge and add gems to the design.
