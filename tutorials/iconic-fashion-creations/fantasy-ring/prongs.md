---
description: 'Objective: Adjust the prong settings for secure gem placement.'
---

# Prongs

### **Steps 1: Prongs Settings**

In the prong settings, select the second option.

Adjust the parameters:

* Prong height: 0.7 millimeters.
* Diameter: 0.6 millimeters.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/Fantasy_7.mp4" %}

**Next Step:** Apply materials and render the model.
