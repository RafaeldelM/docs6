...
To enable the **Named View**, follow these steps:

1. Type "Named View" in the command bar.
2. Press "Enter."
...
**Tip:** This option only saves views from the camera, in the case of moving, rotating or copying elements in a view, the saved views will also be affected.
