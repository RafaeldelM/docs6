...
In this course, you’ll learn how to create a breathtaking halo ring with a classic cathedral shank and shimmering halo setting, using the powerful tools of RhinoArtisan. Each section guides you through creating an intricate halo, setting precise prongs, and designing a flawless shank. By the end, you’ll have an impressive, professional render that’s ready to showcase.
...
This course is perfect for jewelry designers, CAD modelers, and anyone interested in advanced jewelry design techniques. Whether you’re new to RhinoArtisan or experienced, you’ll gain valuable skills to create and render complex ring designs.

### What You’ll Need

You’ll need RhinoArtisan installed. This course includes clear, step-by-step instructions for each technique, ensuring an easy-to-follow learning experience.
