---
description: 'Objective: Set up the basket for the gem and adjust its parameters.'
---
...
* Change the diameter to **1.1 millimeters**.
* Set the height to **3.5 millimeters**.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/07/3_L2.mp4" %}

**Next Step**: Adjust the basket rail settings.
