---
description: >-
  Objective: Learn how to add and position a half-carat diamond using different
  tools in RhinoArtisan.
---

# Selecting the Diamond

In this lesson, we are going to work with a half-carat diamond. RhinoArtisan provides several methods to add gemstones to your design. Let's explore the options available for selecting and positioning your diamond.
...
{% embed url="https://www.rhinoartisan.com/wp-content/uploads/2024/08/three-ways-to-add-gems.mp4" %}

#### Next Steps

In the next lesson, we will learn how to create a beautiful basket setting for our gem.&#x20;
