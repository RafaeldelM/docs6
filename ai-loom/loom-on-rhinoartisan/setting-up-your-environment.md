...
1. Visit the Connect platform:\
   [https://connect.rhinoartisan.com/](https://connect.rhinoartisan.com/)
...
5. The system will ask you for a **name**. You can choose any name you like - it's only for your own reference. For example: _RhinoArtisan_.
